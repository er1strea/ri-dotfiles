...
(function KeyboardShortcut() {
	...
	const binds = {
		...
		"ctrl+j": { callback: () => rotateSidebar(1) },
		"ctrl+k": { callback: () => rotateSidebar(-1) },
		...
		"shift+j": { callback: () => Spicetify.Platform.History.goBack() },
		"shift+k": { callback: () => Spicetify.Platform.History.goForward() },

		// M to Like/Unlike track
		"ctrl+y": { callback: () => Spicetify.Player.toggleHeart() },
		...
		p: { callback: () => Spicetify.Player.back() },
		n: { callback: () => Spicetify.Player.next() },

		// CTRL + Arrow Up Increase Volume CTRL + Arrow Down Decrease Volume
		"+":{ callback: () => Spicetify.Player.setVolume(Spicetify.Player.getVolume() + 0.02) },
		"=":{ callback: () => Spicetify.Player.setVolume(Spicetify.Player.getVolume() + 0.02) },
		"-": { callback: () => Spicetify.Player.setVolume(Spicetify.Player.getVolume() - 0.02) },
